...
local image_0_source = 'https://i.imgur.com/WRsO6Yi.png'
...
function script.drawUI()
    if creditTimer > 0 then
        ...
        display.text({
            text = 'Welcome to StreetSync.org Community!\n https://discord.gg/gKhhmC25BA',
...
-------------------------------------------------------------------
    ...
    positionImage(image_1, 'bottom_left', debugImage)
